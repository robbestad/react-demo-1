...
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Masthead=React.createClass({displayName:"Masthead",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,width=document.body.clientWidth;this.setProps({scrollTop:-scrollTop,logoTop:scrollTop/1.75,width:width})},render:function(){var divStyle={position:"absolute",top:this.props.scrollTop,left:"0",width:"100%",height:"100%",backgroundSize:"cover",transform:"translateZ(0) scale(1)",zIndex:"-1",textAlign:"center"},logoStyle={top:this.props.logoTop,color:"black",width:"150px",fontSize:"5em",left:this.props.width/2-110+"px",position:"absolute"};return React.DOM.div({"class":"masthead",style:divStyle},React.DOM.h1({style:logoStyle},this.props.title))}});React.renderComponent(Masthead({title:"React"}),document.getElementById("masthead"));
...
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Menu=React.createClass({displayName:"Menu",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,menuTop=document.getElementById("menu").style.position,width=document.body.clientWidth;this.setProps({scrollTop:scrollTop,menuTop:menuTop,width:width})},render:function(){var width=document.getElementById("mainRow").clientWidth/3-2,opacity=this.props.scrollTop/500<=1?this.props.scrollTop/700>0?this.props.scrollTop/500:0:1;if(this.props.scrollTop>=222){opacity=1,$(".mainRow").css("paddingTop","30px"),$(".masthead").css("background","white");var divStyle={display:"block",position:"fixed",top:"0px",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"0",borderBottom:"1px solid black"}}else var divStyle={display:"block",position:"relative",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"1px solid black",borderBottom:"1px solid black"};$(".content").css("opacity",opacity);var ulStyle={display:"block",height:"30px",marginBottom:"10px",listStyle:"none outside none",margin:"0px",padding:"0px",textAlign:"center"};return React.DOM.section({style:divStyle,id:"menu"},React.DOM.div(null,React.DOM.ul({style:ulStyle},React.DOM.li({style:liStyle},React.DOM.a({href:"#automation"},this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#speed"},"-",this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#source"})))))}});React.renderComponent(Menu({title:"React"}),document.getElementById("menu"));
