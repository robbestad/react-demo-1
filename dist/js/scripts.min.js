!function(){"use strict"}(),jQuery(function($){var scrollPosition=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop];(setNavbar=function(){$(".navbar ul>li").css("width",$(".content").width()/3-2+"px")})(),$(document).ready(function(){$(".navbar-wrapper").stickUp(),setNavbar()}),$(window).resize(function(){setNavbar()}),$(".modal-event").on("click",function(){$(".modal-img").attr("src",$(this).attr("src")),scrollPosition=[self.pageXOffset||document.documentElement.scrollLeft||document.body.scrollLeft,self.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop],$("#masthead").css("opacity",0),$("#masthead").css("backgroundColor","white"),$(".row").css("opacity",0),$("#menu").css("opacity",0),$("html").css("position","fixed"),$(".modal-close").css("zIndex","9999")}),$(".modal-close").on("click",function(){$("html").css("position","relative"),window.scrollTo(scrollPosition[0],scrollPosition[1]),$("body").css("opacity",1),$("#masthead").css("opacity",1),$(".row").css("opacity",1),$("#menu").css("opacity",1)})});
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Masthead=React.createClass({displayName:"Masthead",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,width=document.body.clientWidth;this.setProps({scrollTop:-scrollTop,logoTop:scrollTop/1.75,width:width})},render:function(){var divStyle={position:"absolute",top:this.props.scrollTop,left:"0",width:"100%",height:"270px",background:"url(img/bg.jpg) no-repeat 50% 50%",backgroundSize:"cover",transform:"translateZ(0) scale(1)",zIndex:"-1",textAlign:"center"},logoStyle={top:this.props.logoTop,color:"black",width:"150px",fontSize:"5em",left:this.props.width/2-110+"px",position:"absolute"};return React.DOM.div({style:divStyle},React.DOM.h1({style:logoStyle},this.props.title))}});React.renderComponent(Masthead({title:"React"}),document.getElementById("masthead"));
...
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Masthead=React.createClass({displayName:"Masthead",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,width=document.body.clientWidth;this.setProps({scrollTop:-scrollTop,logoTop:scrollTop/1.75,width:width})},render:function(){var divStyle={position:"absolute",top:this.props.scrollTop,left:"0",width:"100%",height:"100%",background:"transparent",transform:"translateZ(0) scale(1)",zIndex:"-1",textAlign:"center"},logoStyle={top:this.props.logoTop,color:"black",width:"150px",fontSize:"5em",left:this.props.width/2-110+"px",position:"absolute"};return React.DOM.div({"class":"masthead",style:divStyle},React.DOM.h1({style:logoStyle},this.props.title))}});React.renderComponent(Masthead({title:"React"}),document.getElementById("masthead"));
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Menu=React.createClass({displayName:"Menu",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,menuTop=document.getElementById("menu").style.position,width=document.body.clientWidth;this.setProps({scrollTop:scrollTop,menuTop:menuTop,width:width})},render:function(){var width=document.getElementById("mainRow").clientWidth/3-2;if(this.props.scrollTop>=332)var divStyle={display:"block",position:"fixed",top:"0px",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"0",borderBottom:"1px solid black"};else var divStyle={display:"block",position:"relative",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"1px solid black",borderBottom:"1px solid black"};var ulStyle={display:"block",height:"30px",marginBottom:"10px",listStyle:"none outside none",margin:"0px",padding:"0px",textAlign:"center"};return React.DOM.section({style:divStyle,id:"menu"},React.DOM.div(null,React.DOM.ul({style:ulStyle},React.DOM.li({style:liStyle},React.DOM.a({href:"#automation"},this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#speed"},"-",this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#source"},"Source")))))}});React.renderComponent(Menu({title:"React"}),document.getElementById("menu"));
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Menu=React.createClass({displayName:"Menu",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,menuTop=document.getElementById("menu").style.position,width=document.body.clientWidth;this.setProps({scrollTop:scrollTop,menuTop:menuTop,width:width})},render:function(){var width=document.getElementById("mainRow").clientWidth/3-2,reducify=200,padding=31,opacity=this.props.scrollTop/reducify<=1?this.props.scrollTop/reducify>0?this.props.scrollTop/reducify:0:1;if(this.props.scrollTop>=250){opacity=1,$(".mainRow").css("paddingTop",padding+"px"),$(".masthead").css("background","white");var divStyle={display:"block",position:"fixed",top:"0px",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"0",borderBottom:"1px solid black"}}else{$(".mainRow").css("paddingTop","0");var divStyle={display:"block",position:"relative",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"0",borderBottom:"1px solid black"}}$(".content").css("opacity",opacity);var ulStyle={display:"block",height:"30px",marginBottom:"10px",listStyle:"none outside none",margin:"0px",padding:"0px",textAlign:"center"};return React.DOM.section({style:divStyle,id:"menu"},React.DOM.div(null,React.DOM.ul({style:ulStyle},React.DOM.li({style:liStyle},React.DOM.a({href:"#automation"},this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#speed"},"-",this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#source"},Math.round(1.2*this.props.scrollTop))))))}});React.renderComponent(Menu({title:"React"}),document.getElementById("menu"));
!function(con){"use strict";for(var prop,method,empty={},dummy=function(){},properties="memory".split(","),methods="assert,clear,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,table,time,timeEnd,timeStamp,trace,warn".split(",");prop=properties.pop();)con[prop]=con[prop]||empty;for(;method=methods.pop();)con[method]=con[method]||dummy}(this.console=this.console||{});
