...
var SetIntervalMixin={componentWillMount:function(){this.intervals=[]},setInterval:function(){this.intervals.push(setInterval.apply(null,arguments))},componentWillUnmount:function(){this.intervals.map(clearInterval)}},Menu=React.createClass({displayName:"Menu",mixins:[SetIntervalMixin],componentDidMount:function(){this.setInterval(this.tick,1)},componentDidMount:function(){this.setInterval(this.tick,0)},tick:function(){var scrollTop=void 0!==window.pageYOffset?window.pageYOffset:(document.documentElement||document.body.parentNode||document.body).scrollTop,menuTop=document.getElementById("menu").style.position,width=document.body.clientWidth;this.setProps({scrollTop:scrollTop,menuTop:menuTop,width:width})},render:function(){var width=document.getElementById("mainRow").clientWidth/3-2,reducify=200,opacity=this.props.scrollTop/reducify<=1?this.props.scrollTop/reducify>0?this.props.scrollTop/reducify:0:1;if(this.props.scrollTop>=250){opacity=1,$(".masthead").css("background","white"),$(".mainRow").css("paddingTop","65px");var divStyle={display:"block",position:"fixed",top:"0px",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"0",borderBottom:"1px solid black"}}else var divStyle={display:"block",position:"relative",width:document.getElementById("mainRow").clientWidth+"px",background:"white"},liStyle={"float":"left",width:width+"px",padding:"10px 5px",borderTop:"1px solid black",borderBottom:"1px solid black"};$(".content").css("opacity",opacity);var ulStyle={display:"block",height:"30px",marginBottom:"10px",listStyle:"none outside none",margin:"0px",padding:"0px",textAlign:"center"};return React.DOM.section({style:divStyle,id:"menu"},React.DOM.div(null,React.DOM.ul({style:ulStyle},React.DOM.li({style:liStyle},React.DOM.a({href:"#automation"},this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#speed"},"-",this.props.scrollTop)),React.DOM.li({style:liStyle},React.DOM.a({href:"#source"})))))}});React.renderComponent(Menu({title:"React"}),document.getElementById("menu"));
